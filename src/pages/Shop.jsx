...
export default function Shop() {
  ...
  return (
    <main className="min-h-screen bg-ivory pt-24 pb-24">
      {/* Header */}
      <div className="bg-white border-b border-stone/50 py-14 text-center mb-10">
        ...
        <div className="flex flex-wrap items-center gap-2 mb-10">
          ...
          {filters.map((f) => (
            <button
              ...
              className={`px-5 py-2 rounded-full text-xs font-semibold tracking-wide border transition-all duration-200 ${
                filter === f.key
